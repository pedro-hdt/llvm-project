//===-- TinyRISCVDisassembler.cpp - Disassembler for TinyRISCV --------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements the TinyRISCVDisassembler class.
//
//===----------------------------------------------------------------------===//
...
namespace {
class TinyRISCVDisassembler : public MCDisassembler {

public:
  TinyRISCVDisassembler(const MCSubtargetInfo &STI, MCContext &Ctx)
...
static MCDisassembler *createTinyRISCVDisassembler(const Target &T,
                                               const MCSubtargetInfo &STI,
                                               MCContext &Ctx) {
  return new TinyRISCVDisassembler(STI, Ctx);
}

extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeTinyRISCVDisassembler() {
  // Register the disassembler for each target.
  TargetRegistry::RegisterMCDisassembler(getTheTinyRISCVTarget(),
                                         createTinyRISCVDisassembler);
}
...
static DecodeStatus DecodeGPRRegisterClass(MCInst &Inst, uint64_t RegNo,
  ...
  Register Reg = TinyRISCV::X0 + RegNo;
...
static DecodeStatus DecodeGPRCRegisterClass(MCInst &Inst, uint64_t RegNo,
  ...
  Register Reg = TinyRISCV::X8 + RegNo;
  Inst.addOperand(MCOperand::createReg(Reg));
  return MCDisassembler::Success;
}
...
static DecodeStatus decodeFRMArg(MCInst &Inst, uint64_t Imm,
  ...
  if (!llvm::TinyRISCVFPRndMode::isValidRoundingMode(Imm))
    return MCDisassembler::Fail;
...
#include "TinyRISCVGenDisassemblerTables.inc"
...
DecodeStatus TinyRISCVDisassembler::getInstruction(MCInst &MI, uint64_t &Size,
  ...
  LLVM_DEBUG(dbgs() << "Trying TinyRISCV32 table :\n");
