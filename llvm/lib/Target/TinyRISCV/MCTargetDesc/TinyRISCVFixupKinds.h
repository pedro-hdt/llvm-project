//===-- TinyRISCVFixupKinds.h - TinyRISCV Specific Fixup Entries --------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_TinyRISCV_MCTARGETDESC_TinyRISCVFIXUPKINDS_H
#define LLVM_LIB_TARGET_TinyRISCV_MCTARGETDESC_TinyRISCVFIXUPKINDS_H
...
enum Fixups {
  ...
  // fixup_riscv_relax - Used to generate an R_TinyRISCV_RELAX relocation type,
  // which indicates the linker may relax the instruction pair.
  fixup_riscv_relax,
  // fixup_riscv_align - Used to generate an R_TinyRISCV_ALIGN relocation type,
