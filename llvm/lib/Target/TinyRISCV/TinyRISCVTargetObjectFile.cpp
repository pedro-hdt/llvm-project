//===-- TinyRISCVTargetObjectFile.cpp - TinyRISCV Object Info -----------------===//
//
...
void TinyRISCVELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool TinyRISCVELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool TinyRISCVELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *TinyRISCVELFTargetObjectFile::SelectSectionForGlobal(
...
void TinyRISCVELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool TinyRISCVELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *TinyRISCVELFTargetObjectFile::getSectionForConstant(
